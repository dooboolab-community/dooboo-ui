...
```sh
expo install dooboo-ui @emotion/react @emotion/native react-native-vector-icons
```
...
```sh
# npm
npm install dooboo-ui @emotion/react @emotion/native react-native-vector-icons

# yarn
yarn add dooboo-ui @emotion/react @emotion/native react-native-vector-icons
```
