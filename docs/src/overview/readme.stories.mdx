...
```sh
expo install dooboo-ui @emotion/react @emotion/native react-native-vector-icons react-native-gesture-handler
```
...
```sh
# npm
yarn add dooboo-ui @emotion/react @emotion/native react-native-vector-icons react-native-gesture-handler
```
