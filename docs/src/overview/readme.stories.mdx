...
> Here are separate packages that are maintained with [Lerna](https://lerna.js.org/) for the mono repo. For more information, please read [dooboo-ui-strategy](https://github.com/dooboolab/dooboo-ui/pull/49)

- [CalendarCarousel](https://github.com/dooboolab/dooboo-ui/tree/main/packages/CalendarCarousel)
- [GiftedChat](https://github.com/dooboolab/dooboo-ui/tree/main/packages/GiftedChat)
- [PinchZoom](https://github.com/dooboolab/dooboo-ui/tree/main/packages/PinchZoom)
