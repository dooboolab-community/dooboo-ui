...
2. Expose all style props in `styles` and style props of parent component in `style`.
   ...
   > You can see the exmaple in [Button L62-L63](https://github.com/dooboolab/dooboo-ui/blob/c0d114c46bbba5a8a8a05e91a782a682e4803dac/main/Button/IconStyles.tsx#L62-L63).
...
3. Provide `react element` when you find that there are more possibilities to have in your component.
   ...
   For example, see the [CheckBox](https://github.com/dooboolab/dooboo-ui/blob/main/main/Checkbox/IconStyles.tsx) component.
